...
public class AutoSuggestionServiceContainer extends AbstractContainer
{

	public static void main(String[] args)
	{
		AutoSuggestionServiceContainer container = new AutoSuggestionServiceContainer();
		try
		{
	...
	public AutoSuggestionServiceContainer()
	{
		super(AutoSuggestionService.NAME);
	}
	...
	protected Object createServiceImpl() throws ContainerException
	{
		...
		try
		{
			service = new AutoSuggestionServiceImpl();
		}
		catch (Exception e)
		{
